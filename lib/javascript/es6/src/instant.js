...
var Settings = {
  ...
  miniThumb: function(changed) {
    var enabled = Settings._checkbox(changed, 'miniThumb', false);
    if (enabled) {
      injector.inject('miniThumb', 'img.thumb:not([alt^="full"]) { max-width: 200px; max-height: 200px; object-fit: scale-down; object-position: top; width: inherit; height: inherit; }');
    } else {
