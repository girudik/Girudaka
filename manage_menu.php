...
if (!$manage_class->ValidateSession(true)) {
	...
	<li class="magic-link" data-help="showpwd"><span id="postingpassword"><a id="showpwd" href="#" onclick="javascript:document.getElementById(\'postingpassword\').innerHTML = \'<input type=text id=postingpasswordbox value=' . $manage_postpassword . '><br>\'; document.getElementById(\'postingpasswordbox\').select(); return false;">'._gettext('Show Posting Password').'</a></span></li></ul>';
	// Home
	$tpl_links .= section_html(_gettext('Home'), 'home') .
	'<ul>
	<li><a href="manage_page.php?">'._gettext('View Announcements').'</a></li>
	<li class="magic-link" data-help="posting_rates"><a href="manage_page.php?action=posting_rates">'._gettext('Posting rates (past hour)').'</a></li>
	<li class="magic-link" data-help="statistics"><a href="manage_page.php?action=statistics">' . _gettext('Statistics') . '</a></li>';
	...
	if ($manage_class->CurrentUserIsAdministrator()) {
		...
		<li class="magic-link" data-help="styles"><a href="manage_page.php?action=styles">' . _gettext('Stylesheet Manager') . '</a></li>
		<li class="magic-link" data-help="banners"><a href="manage_page.php?action=banners">' . _gettext('Manage banners') . '</a></li>
